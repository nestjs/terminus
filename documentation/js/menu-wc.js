...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    <ul class="list">
        <li class="title">
            <a href="index.html" data-type="index-link">@brunnerlivio/terminus documentation</a>
        </li>
        <li class="divider"></li>
...
` : '' }
        ...
        <li class="chapter modules">
            ...
            ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                    <li class="link">
                        <a href="modules/TerminusCoreModule.html" data-type="entity-link">TerminusCoreModule</a>
                    </li>
                    <li class="link">
        ...
        <li class="chapter">
            ...
            ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                    <li class="link">
                        <a href="interfaces/HealthCheckMap.html" data-type="entity-link">HealthCheckMap</a>
                    </li>
                    <li class="link">
                        <a href="interfaces/TerminusModuleAsyncOptions.html" data-type="entity-link">TerminusModuleAsyncOptions</a>
                    </li>
                    <li class="link">
                        <a href="interfaces/TerminusOptions.html" data-type="entity-link">TerminusOptions</a>
                    </li>
                    <li class="link">
